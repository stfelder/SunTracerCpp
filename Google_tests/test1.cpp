...
TEST(calculateSunAltitude_Test, Determine_the_height_of_the_sun) {
    ...
    EXPECT_NEAR(sunTracer.getAltitue_Degress(latitude, declination, hourAngle), 54.63, tolerance);
}
...
TEST(calculateSunAltitude_Test_Determine_the_height_of_the_sun_Test, Determine_the_height_of_the_sun) {
    ...
    EXPECT_NEAR(sunTracer.getAltitue_Degress(latitude, longitude, year, month, day, hour, minute, second), 23.56, tolerance);
}
...
TEST(calculateSunAzimuth_Test, Determine_the_azimuth_of_the_sun) {
    ...
    double tolerance = 0.5;
    // https://www.sonnenverlauf.de/#/47.2047,8.5341,8/2024.03.29/08:36/1/3
    EXPECT_NEAR(sunTracer.calculateSunAzimuth(latitude, longitude, year, month, day, hour, minute, second), 111.66, tolerance);
}
...
TEST(calculateSunAzimuth_Test2, Determine_the_azimuth_of_the_sun) {
    ...
    EXPECT_NEAR(sunTracer.calculateSunAzimuth(latitude, longitude, year, month, day, hour, minute, second), 84.16, tolerance);
}
...
TEST(calculateSunAzimuth_and_Altitude_Test, Determine_the_azimuth_and_height_of_the_sun) {
    ...
    EXPECT_NEAR(sunTracer.getAltitue_Degress(latitude, longitude, year, month, day, hour, minute, second), 41.72, tolerance);
    EXPECT_NEAR(sunTracer.calculateSunAzimuth(latitude, longitude, year, month, day, hour, minute, second), 143.39, tolerance);
...
TEST(calculateSunAzimuth_and_Altitude_Test, Determine_the_azimuth_and_height_of_the_sun_South_side_Equator) {
    ...
    EXPECT_NEAR(sunTracer.getAltitue_Degress(latitude, longitude, year, month, day, hour, minute, second), 47.77, tolerance);
    EXPECT_NEAR(sunTracer.calculateSunAzimuth(latitude, longitude, year, month, day, hour, minute, second), 50.95, tolerance);
}
...
TEST(calculateSunAzimuth_and_Altitude_Test, Determine_the_azimuth_and_height_of_the_sun_Eeast_side_longitude) {
    ...
    EXPECT_NEAR(sunTracer.getAltitue_Degress(latitude, longitude, year, month, day, hour, minute, second), 40.41, tolerance);
    EXPECT_NEAR(sunTracer.calculateSunAzimuth(latitude, longitude, year, month, day, hour, minute, second), 122.20, tolerance);
}
...
TEST(calculateSunAzimuth_and_Altitude_Test, Determine_the_azimuth_and_height_of_the_sun_Eeast_side_longitude_and_South_side_Equator) {
    ...
    EXPECT_NEAR(sunTracer.getAltitue_Degress(latitude, longitude, year, month, day, hour, minute, second), 32.26, tolerance);
    EXPECT_NEAR(sunTracer.calculateSunAzimuth(latitude, longitude, year, month, day, hour, minute, second), 56.08, tolerance);
}